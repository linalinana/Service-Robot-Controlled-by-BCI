...
if("TRUE" STREQUAL "TRUE")
  set(topic_demo_SOURCE_PREFIX /home/nana/catkin_ws /src/topic_demo)
  set(topic_demo_DEVEL_PREFIX /home/nana/catkin_ws /devel)
  ...
  set(topic_demo_INSTALL_PREFIX /home/nana/catkin_ws /install)
...
if(NOT "/home/nana/catkin_ws /devel/include " STREQUAL " ")
  set(topic_demo_INCLUDE_DIRS "")
  set(_include_dirs "/home/nana/catkin_ws /devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'nana <nana@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'topic_demo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nana/catkin_ws /src/topic_demo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nana/catkin_ws /devel/lib;/home/nana/turtlebot/devel/lib;/opt/ros/kinetic/lib)
