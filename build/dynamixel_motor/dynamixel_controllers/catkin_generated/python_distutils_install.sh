...
echo_and_run cd "/home/nana/catkin_ws /src/dynamixel_motor/dynamixel_controllers"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nana/catkin_ws /src/dynamixel_motor/dynamixel_controllers/setup.py" \
     \
    build --build-base "/home/nana/catkin_ws /build/dynamixel_motor/dynamixel_controllers" \
    install \
    --root="${DESTDIR-/}" \
